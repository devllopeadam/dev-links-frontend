          ...
          {/* The full name and the email */}
          {
            !isLoading
              ...
              : <div role="status" className="animate-pulse mt-5">
                <div className="h-6 bg-gray-200 rounded-lg dark:bg-gray-700 w-48 mb-4 mx-auto"></div>
                <div className="h-2.5 bg-gray-200 rounded-full dark:bg-gray-700 max-w-[160px] mb-7 mx-auto"></div>
              </div>
          }
        </div>
        {/* links */}
